...
export const phoneSchema = z.preprocess(
  (v) => (typeof v === "string" && v.trim() === "" ? undefined : v),
  z.string().trim().regex(phoneRegex, "Invalid phone number").optional()
);

// Messenger PSID (optional, no strict validation)
export const messengerSchema = z.preprocess(
  (v) => (typeof v === "string" && v.trim() === "" ? undefined : v),
  z.string().optional()
);
...
export const savedSearchSchema = z.object({
  ...
  max_price: z.coerce.number().min(0, "Max price must be ≥ 0"),
//   criteria_json: z.string().min(1, "Criteria required"),
});
