...
SYSTEM_PROMPT = (
    ...
    "Be conservative. Scoring: 90-100 exceptional, 80-89 strong, 70-79 decent, 60-69 marginal, <60 pass. "
    "Flip: >=12% gross margin over all-in; MTR: CoC>=8% at 80% occ; Buy&Hold: DSCR>=1.15 at base+150bps. "
...
SCHEMA = {
  ...
  "properties":{
    ...
    "summary":{"type":"string"},
    "strategyFit":{"type":"array","items":{"type":"string","enum":["Buy&Hold","MTR","Flip"]}},
...
def analyze_listing(listing: dict) -> dict:
    if not settings.OPENAI_API_KEY:
        ...
        return {
            ...
            "dealBreakers": [],
            "nextSteps": ["Pull comps 0.5mi/6mo", "Estimate rehab", "Confirm DSCR at 7.5%"]
        }
