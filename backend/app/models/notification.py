...
class Notification(BaseModel):
    ...
    status:  Mapped[str] = mapped_column(NotificationStatus, nullable=False, default="sent")
    ...
    client_id: Mapped[UUID | None] = mapped_column(UUID(as_uuid=True), ForeignKey("clients.id", ondelete="SET NULL"))
    saved_search_id: Mapped[UUID | None] = mapped_column(UUID(as_uuid=True), ForeignKey("saved_searches.id", ondelete="SET NULL"))
