...
R2_S3_ENDPOINT = os.environ["R2_S3_ENDPOINT"]      # https://<ACCOUNT_ID>.r2.cloudflarestorage.com
...
def upload_bytes_and_get_url(key: str, data: bytes, content_type: str = "image/png") -> str:
